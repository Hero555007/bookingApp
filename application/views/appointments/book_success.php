                ...
                <div class="col-xs-12 col-sm-10">
                    <?php
                        echo '
                            ...
                            <a class="btn btn-success btn-large redirectWithData">
                                <span class="glyphicon glyphicon-calendar"></span> ' .
                                lang('go_to_booking_page') . '
                            </a>
                            <a class="btn btn-success btn-large redirectfirstpage">
...
<script type="text/javascript">
    $(document).ready(function(){
      $('.redirectWithData').on('click',function(){
            // var postUrl = GlobalVariables.baseUrl + '/index.php/appointments/get_hash';
            //  $.ajax({
            //     type: "POST",
            //     url: postUrl,
            //     data: { notes : 'hlo'},
            //     success: function(result) {
            //         window.location.href = GlobalVariables.baseUrl + "/index.php/appointments/index/"+result;
            //     }
            // });
        window.location.href = GlobalVariables.baseUrl;
    });
      $('.redirectfirstpage').on('click',function(){
        // window.location.href = GlobalVariables.baseUrl;
        window.top.close();
      });
    });
