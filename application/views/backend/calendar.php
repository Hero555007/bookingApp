                ...
                <form>
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group">
                                    <label for="start-datetime" class="control-label" style="width: 100%;"><?= lang('start_date_time') ?></label>
                                    <div class="input-group" style="display: inline;">
                                        <label style="margin-left: 15px;">Date:</label>
                                        <input id="start-datetime" class="required" style="width:120px; border:none; font-size:16px; border-bottom:1px solid rgb(0 0 0 / 0.1); margin-top:5px; padding-left:15px;">
                                        <label style="margin-left:15px;">Time:</label>
                                        <select style="width: 120px; height:31px;font-size:16px; padding-left:15px;" id="startTimeList"></select>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="end-datetime" class="control-label"><?= lang('end_date_time') ?></label>
                                    <input id="end-datetime" class="required form-control" style="padding-left: 15px;" disabled>
                                </div>
                            </div>
                        </div>
