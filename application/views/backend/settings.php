                ...
                <fieldset>
                    ...
                    <div class="wrapper row">
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="company-telnum"><?= lang('company_telnum') ?> *</label>
                                <input id="company-telnum" data-field="company_telnum" class="required form-control" placeholder="555-5555-5555">
                                <input type="text" id="form2" class="form-control" style="display: none;">
                                <span class="help-block">
                                    <?= lang('company_telnum_hint') ?>
                                </span>
                            </div>

                            <div class="form-group">
                                <label for="login-text"><?= lang('login_text') ?> *</label>
                                <input id="login-text" data-field="login_text" class="required form-control">
                                <span class="help-block">
                                    <?= lang('login_text_hint') ?>
                                </span>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6">
