...
class Migration_Legal_contents extends CI_Migration {
    public function up()
    {
        ...
        $this->db->insert('ea_settings', ['name' => 'company_name', 'value' => 'KiwiPCHelp Ltd']);
        $this->db->insert('ea_settings', ['name' => 'company_email', 'value' => 'help@kiwipchelp.com']);
        $this->db->insert('ea_settings', ['name' => 'company_link', 'value' => 'http://www.kiwipchelp.com']);
        $this->db->insert('ea_settings', ['name' => 'company_telnum', 'value' => '042972700']);
        $this->db->insert('ea_settings', ['name' => 'login_text', 'value' => 'Hi']);
    ...
    public function down()
    {
        ...
        $this->db->delete('ea_settings', ['name' => 'company_name']);
        $this->db->delete('ea_settings', ['name' => 'company_email']);
        $this->db->delete('ea_settings', ['name' => 'company_link']);
        $this->db->delete('ea_settings', ['name' => 'company_telnum']);
        $this->db->delete('ea_settings', ['name' => 'login_text']);
